      ...
      <div className="hero--section--content--box about--section--box">
        <div className="hero--section--content">
          ...
          <p className="hero--section-description">
           Hii, My name is Yash Nareshbhai Mangrola. Currently third year undergraduate student in shree ramkrishna institute of science & technology. Studying BSC(Information Technology).
          </p>
          <p className="hero--section-description">
           And for more about me you can check my resume.
          </p>
        </div>
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.instagram.com/yash_mangrola_/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/yash-mangrola-801546247/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
